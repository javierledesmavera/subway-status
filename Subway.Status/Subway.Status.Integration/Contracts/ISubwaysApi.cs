...
namespace Subway.Status.Integration.Contracts
{
    public interface ISubwaysApi
    {
        ...
        Task <SubwayApiResponse<ServiceAlertsHeader, ServiceAlerts>> GetServiceAlerts([AliasAs("client_id")]string clientId, [AliasAs("client_secret")]string clientSecret, int json = 1);
